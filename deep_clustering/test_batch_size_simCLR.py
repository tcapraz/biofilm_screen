...
epochs = 1
for b in range(200,512):
    train_loader = torch.utils.data.DataLoader(augdataset, batch_size=b, shuffle=True, pin_memory=True,num_workers=8, drop_last=True)
