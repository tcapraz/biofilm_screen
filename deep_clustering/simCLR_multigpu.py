...
model= torch.load("simCLR212_multi.pth", map_location="cpu")
...
out.to_csv("featuresSimCLR212_multi.csv")
...
out.to_csv("latentSimCLR212_multi.csv")

torch.save(model, "simCLR212_multi.pth")
