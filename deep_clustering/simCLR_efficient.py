...
train_loader = torch.utils.data.DataLoader(augdataset, batch_size=256, shuffle=True, pin_memory=True,num_workers=8, drop_last=True)
...
#model= torch.load("simCLR212.pth")
model.to(dev)
...
out.to_csv("featuresSimCLRefficient.csv")
...
out.to_csv("latentSimCLRefficient.csv")

torch.save(model, "simCLRefficient.pth")
