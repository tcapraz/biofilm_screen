...
#model= torch.load("simCLR_clahe.pth")
model.to(dev)
...
out.to_csv("featuresSimCLR_clahe.csv")
...
out.to_csv("latentSimCLR_clahe.csv")

torch.save(model, "simCLR_clahe.pth")
